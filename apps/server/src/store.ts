import { User, Group, Expense, Settlement, Donation, ActivityLog } from 'shared-types';

export class SettlStore {
  users: User[] = [];
  groups: Group[] = [];
  expenses: Expense[] = [];
...
export const store = new SettlStore();
